...
- Filebeat tails and ships log data.  You could expect to see [somthing like this](diagrams/logEx.png) from filebeat.  Metricbeat monitors system services that are running such as Apache.  An other example of metricbeat would be collecting [CPU usage data.](diagrams/metricCPU.png)
